...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Dialog = __webpack_require__(160);
	var AIWorker = __webpack_require__(236);
	var App = (function (_super) {
	    ...
	    App.prototype.handleCellClick = function (cellRef) {
	        ...
	        if (!(this.state.gameState.currTurn == this.state.gameState.playerXorO)
	            ...
	            || this.game.gameState.cellList[cellRef.id] == undefined)
	            return;
	    ...
	    App.prototype.setXorO = function (selection) {
	    ...
	    App.prototype.replay = function () {
	        ...
	        if (this.state.gameState.winner) {
	            var buttonText = '';
	            if (this.state.gameState.winner == 'Draw')
	                buttonText = "It's a draw!";
	            else
	                buttonText = this.state.gameState.winner + " wins!";
	            return React.createElement("span", {"id": "replay", "onClick": function () { return _this.resetGame(); }}, buttonText, " Play again?");
	        }
	        else
	    ...
	    App.prototype.render = function () {
	        var _this = this;
	        return (React.createElement("div", null, React.createElement("div", {"id": "page-wrapper"}, React.createElement("h2", null, React.createElement("span", {"id": "pop"}, "#"), "Tic Tac Toe"), React.createElement(GameInfo, {"game": this.state.gameState, "reset": function () { return _this.resetGame(); }, "setXorO": function (selection) { return _this.setXorO(selection); }}), React.createElement(Board, {"cellClick": function (cellRef) { return _this.handleCellClick(cellRef); }, "game": this.state.gameState}), React.createElement("div", null, this.replay())), React.createElement(Foot, null)));
	    };
	    return App;
	})(React.Component);
	var GameInfo = (function (_super) {
	    ...
	    GameInfo.prototype.handleOpen = function () {
	        //this.setState({open: true});
	    };
	    GameInfo.prototype.handleClose = function (selection) {
	        //this.setState({open: false});
	        this.props.setXorO(selection);
	    };
	    GameInfo.prototype.resetGame = function () {
	        this.props.reset();
	    };
	    GameInfo.prototype.turnText = function () {
	        var text = '';
	        if (!this.gameState.winner)
	            text = "Next move: " + this.gameState.currTurn;
	    ...
	    GameInfo.prototype.getShape = function (which) {
	        switch (which) {
	            case 'player':
	                if (this.gameState.playerXorO == 'X')
	                    return (React.createElement("img", {"src": "http://res.cloudinary.com/dz9rf4hwz/image/upload/v1452555694/tictactoe-x_ni4rto.png", "className": "shapeDisplay"}));
	                else if (this.gameState.playerXorO == 'O')
	                    return (React.createElement("img", {"src": "http://res.cloudinary.com/dz9rf4hwz/image/upload/v1452554295/tictactoe-o_h3sgbo.png", "className": "shapeDisplay"}));
	                break;
	            case 'agent':
	                if (this.gameState.agentXorO == 'X')
	                    return (React.createElement("img", {"src": "http://res.cloudinary.com/dz9rf4hwz/image/upload/v1452555694/tictactoe-x_ni4rto.png", "className": "shapeDisplay"}));
	                else if (this.gameState.agentXorO == 'O')
	                    return (React.createElement("img", {"src": "http://res.cloudinary.com/dz9rf4hwz/image/upload/v1452554295/tictactoe-o_h3sgbo.png", "className": "shapeDisplay"}));
	                break;
	        }
	    };
	    GameInfo.prototype.getTurn = function (which) {
	        var className = 'playerDiv';
	        switch (which) {
	            case 'player':
	                if (this.gameState.currTurn == this.gameState.playerXorO)
	    ...
	    GameInfo.prototype.loading = function () {
	        if (this.gameState.loading)
	            return React.createElement("i", {"className": "fa fa-cog fa-spin"});
	    };
	    GameInfo.prototype.render = function () {
	        var _this = this;
	        var actions = [
	            React.createElement("img", {"src": "http://res.cloudinary.com/dz9rf4hwz/image/upload/v1452555694/tictactoe-x_ni4rto.png", "className": "dialogShape", "onClick": function () { return _this.handleClose('X'); }}),
	            React.createElement("img", {"src": "http://res.cloudinary.com/dz9rf4hwz/image/upload/v1452554295/tictactoe-o_h3sgbo.png", "className": "dialogShape", "onClick": function () { return _this.handleClose('O'); }})
	        ];
	        return (React.createElement("div", null, React.createElement("div", {"className": this.getTurn('player')}, "Player: ", this.getShape('player')), React.createElement("div", {"className": this.getTurn('agent'), "id": "agentDiv"}, "Computer: ", this.getShape('agent'), " ", this.loading()), React.createElement(Dialog, {"title": "Pick Your Shape", "actions": actions, "modal": false, "open": this.gameState.playerXorO == '', "onRequestClose": function () { return _this.handleClose(''); }}, "Remember, ", React.createElement("img", {"src": "http://res.cloudinary.com/dz9rf4hwz/image/upload/v1452555694/tictactoe-x_ni4rto.png", "className": "shapeDisplay"}), " always moves first!")));
	    };
	    return GameInfo;
	})(React.Component);
	var Board = (function (_super) {
	    ...
	    function Board(props) {
	        _super.call(this, props);
	        this.xImg = 'http://res.cloudinary.com/dz9rf4hwz/image/upload/v1452555694/tictactoe-x_ni4rto.png';
	        //xRedImg = 'http://res.cloudinary.com/dz9rf4hwz/image/upload/v1452656591/tictactoe-x-red_nvretc.png';
	        this.oImg = 'http://res.cloudinary.com/dz9rf4hwz/image/upload/v1452554295/tictactoe-o_h3sgbo.png';
	        this.gameState = this.props.game;
	    }
	    Board.prototype.cellClick = function (clickedCell) {
	        this.props.cellClick(clickedCell);
	    };
	    Board.prototype.checkContents = function (cell) {
	        if (this.gameState.cellList[cell].xoro == 'X')
	            return React.createElement("img", {"src": this.xImg});
	        else if (this.gameState.cellList[cell].xoro == 'O')
	            return React.createElement("img", {"src": this.oImg});
	        else
	            return React.createElement("div", null);
	    };
	    Board.prototype.getWinCanvas = function () {
	    ...
	    Board.prototype.render = function () {
	        ...
	        return (React.createElement("div", {"id": "board-wrapper"}, React.createElement("table", {"id": "game-board"}, React.createElement("tr", {"id": "top-row"}, React.createElement("td", {"className": "left-column cell-container", "id": "cell1", "onClick": function (e) { return _this.cellClick(e.target); }}, this.checkContents("cell1")), React.createElement("td", {"className": "cell-container", "id": "cell2", "onClick": function (e) { return _this.cellClick(e.target); }}, this.checkContents("cell2")), React.createElement("td", {"className": "right-column cell-container", "id": "cell3", "onClick": function (e) { return _this.cellClick(e.target); }}, this.checkContents("cell3"))), React.createElement("tr", {"id": "middle-row"}, React.createElement("td", {"className": "left-column cell-container", "id": "cell4", "onClick": function (e) { return _this.cellClick(e.target); }}, this.checkContents("cell4")), React.createElement("td", {"className": "cell-container", "id": "cell5", "onClick": function (e) { return _this.cellClick(e.target); }}, this.checkContents("cell5")), React.createElement("td", {"className": "right-column cell-container", "id": "cell6", "onClick": function (e) { return _this.cellClick(e.target); }}, this.checkContents("cell6"))), React.createElement("tr", {"id": "bottom-row"}, React.createElement("td", {"className": "left-column cell-container", "id": "cell7", "onClick": function (e) { return _this.cellClick(e.target); }}, this.checkContents("cell7")), React.createElement("td", {"className": "cell-container", "id": "cell8", "onClick": function (e) { return _this.cellClick(e.target); }}, this.checkContents("cell8")), React.createElement("td", {"className": "right-column cell-container", "id": "cell9", "onClick": function (e) { return _this.cellClick(e.target); }}, this.checkContents("cell9")))), React.createElement("canvas", {"ref": "winCanvas", "id": "win-strike-container", "width": "460", "height": "487", "hidden": this.gameState.winner == ''})));
	    };
	    return Board;
	})(React.Component);
	...
	var Game = (function () {
	    function Game(refreshState) {
	        var _this = this;
	        this.canvasDimens = { width: 460, height: 487 };
	        this.winStrikes = (_a = {},
	            _a['horizTop'] = { start: { x: 0, y: this.canvasDimens.height / 3 / 2 },
	                end: { x: this.canvasDimens.width, y: this.canvasDimens.height / 3 / 2 } },
	            _a['horizMid'] = { start: { x: 0, y: this.canvasDimens.height / 2 },
	                end: { x: this.canvasDimens.width, y: this.canvasDimens.height / 2 } },
	            _a['horizBot'] = { start: { x: 0, y: this.canvasDimens.height - this.canvasDimens.height / 3 / 2 },
	                end: { x: this.canvasDimens.width, y: this.canvasDimens.height - this.canvasDimens.height / 3 / 2 } },
	            _a['vertLeft'] = { start: { x: this.canvasDimens.width / 3 / 2, y: 0 },
	                end: { x: this.canvasDimens.width / 3 / 2, y: this.canvasDimens.height } },
	            _a['vertMid'] = { start: { x: this.canvasDimens.width / 2, y: 0 },
	                end: { x: this.canvasDimens.width / 2, y: this.canvasDimens.height } },
	            _a['vertRight'] = { start: { x: this.canvasDimens.width - this.canvasDimens.width / 3 / 2, y: 0 },
	                end: { x: this.canvasDimens.width - this.canvasDimens.width / 3 / 2, y: this.canvasDimens.height } },
	            _a['diagDown'] = { start: { x: 0, y: 0 },
	                end: { x: this.canvasDimens.width, y: this.canvasDimens.height } },
	            _a['diagUp'] = { start: { x: 0, y: this.canvasDimens.height },
	        ...
	        this.agentWorker.onmessage = function (e) {
	            // Worker returns single string cell as next move
	            _this.makeMove(e.data);
	        };
	        var _a, _b;
	    }
	    Game.prototype.setXorO = function (selection) {
	        this.gameState.playerXorO = selection;
	        if (this.gameState.playerXorO == 'X')
	            this.gameState.agentXorO = 'O';
	        else
	            this.gameState.agentXorO = 'X';
	        this.refreshState();
	        if (this.gameState.currTurn == this.gameState.agentXorO) {
	    ...
	    Game.prototype.makeMove = function (cellID) {
	        ...
	        var clickedCell = this.gameState.cellList[cellID];
	        if (!clickedCell.xoro)
	    ...
	    Game.prototype.nextTurn = function () {
	        var gameCondition = this.checkWinCondition(this.gameState);
	        if (gameCondition.state == 'Win') {
	            ...
	            if (this.gameState.currTurn == "X")
	                this.gameState.currTurn = "O";
	            else
	    ...
	    Game.prototype.resetGame = function () {
	        ...
	        for (var key in this.gameState.cellList) {
	    ...
	    Game.prototype.drawWinStrike = function (winRow) {
	        var canvas = document.getElementById('win-strike-container');
	        var ctx = canvas.getContext('2d');
	        ctx.clearRect(0, 0, this.canvasDimens.width, this.canvasDimens.height);
	        ctx.strokeStyle = "red";
	    ...
	    Game.prototype.getMoveAt = function (state, position) {
	        return state.cellList[("cell" + position)].xoro;
	    };
	    Game.prototype.checkRow = function (state, pos1, pos2, pos3) {
	        if (!this.getMoveAt(state, pos1))
	            return false;
	        if (this.getMoveAt(state, pos1) == this.getMoveAt(state, pos2) &&
	            this.getMoveAt(state, pos2) == this.getMoveAt(state, pos3))
	            return true;
	        else
	            return false;
	    };
	    Game.prototype.checkWinCondition = function (state) {
	        // Horizontal Wins
	        if (this.checkRow(state, '1', '2', '3'))
	            return { state: 'Win', winner: this.getMoveAt(state, '1'), winRow: 'horizTop' };
	        if (this.checkRow(state, '4', '5', '6'))
	            return { state: 'Win', winner: this.getMoveAt(state, '4'), winRow: 'horizMid' };
	        if (this.checkRow(state, '7', '8', '9'))
	            return { state: 'Win', winner: this.getMoveAt(state, '7'), winRow: 'horizBot' };
	        // Vertical Wins
	        if (this.checkRow(state, '1', '4', '7'))
	            return { state: 'Win', winner: this.getMoveAt(state, '1'), winRow: 'vertLeft' };
	        if (this.checkRow(state, '2', '5', '8'))
	            return { state: 'Win', winner: this.getMoveAt(state, '2'), winRow: 'vertMid' };
	        if (this.checkRow(state, '3', '6', '9'))
	            return { state: 'Win', winner: this.getMoveAt(state, '3'), winRow: 'vertRight' };
	        // Diagonal Wins 
	        if (this.checkRow(state, '1', '5', '9'))
	            return { state: 'Win', winner: this.getMoveAt(state, '1'), winRow: 'diagDown' };
	        if (this.checkRow(state, '3', '5', '7'))
	            return { state: 'Win', winner: this.getMoveAt(state, '3'), winRow: 'diagUp' };
	        for (var key in state.cellList) {
	            // No win and empty spaces left on board, continue game
	            if (state.cellList[key].xoro == '')
	                return { state: 'None', winner: '', winRow: '' };
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _windowListenable = __webpack_require__(161);
	...
	var _stylePropable = __webpack_require__(165);
	...
	var _renderToLayer = __webpack_require__(231);
	...
	var _lightRawTheme = __webpack_require__(202);
	
	var _lightRawTheme2 = _interopRequireDefault(_lightRawTheme);
	
	var _themeManager = __webpack_require__(205);
	...
	var _deprecatedPropType = __webpack_require__(235);
	
	var _deprecatedPropType2 = _interopRequireDefault(_deprecatedPropType);
	
	var _reactAddonsTransitionGroup = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _immutabilityHelper = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _autoPrefix = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _contextPure = __webpack_require__(184);
	...
	var _enhancedButton = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _colors = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsPureRenderMixin = __webpack_require__(193);
	...
	var _focusRipple = __webpack_require__(196);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scaleIn = __webpack_require__(197);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scaleInChild = __webpack_require__(201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lightBaseTheme = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _spacing = __webpack_require__(204);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extend = __webpack_require__(206);
	
	var _extend2 = _interopRequireDefault(_extend);
	
	var _getMuiTheme = __webpack_require__(207);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _zIndex = __webpack_require__(225);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dom = __webpack_require__(227);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function() {
		return new Worker(__webpack_require__.p + "f20ad7b8d6020803e3ae.worker.js");
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#page-wrapper {\n  min-height: 896px;\n  height: 100vh;\n  width: 100%;\n  margin-bottom: -80px;\n  font: normal 30px \"Open Sans\";\n  text-align: center; }\n  #page-wrapper #pop {\n    color: #5bd28b;\n    transition: 0.3s; }\n  #page-wrapper h2 {\n    color: #403e3b; }\n    #page-wrapper h2:hover #pop {\n      color: #403e3b; }\n  #page-wrapper #replay {\n    color: #403e3b;\n    border: 1px solid #5bd28b;\n    border-radius: 14px;\n    padding: 8px;\n    font-size: 20px;\n    position: relative;\n    top: 5px;\n    left: 5px;\n    transition: 0.2s; }\n    #page-wrapper #replay:hover {\n      cursor: pointer;\n      color: aliceblue;\n      background-color: #5bd28b; }\n    #page-wrapper #replay:active {\n      background-color: #9be4b8; }\n  #page-wrapper #board-wrapper {\n    position: relative;\n    display: inline-block;\n    margin: 0 auto;\n    margin-top: 10px; }\n    #page-wrapper #board-wrapper #game-board {\n      text-align: center;\n      border-spacing: 0; }\n      #page-wrapper #board-wrapper #game-board .cell-container {\n        position: relative; }\n      #page-wrapper #board-wrapper #game-board .cell {\n        position: absolute;\n        bottom: 0px;\n        height: 150px;\n        width: 150px; }\n      #page-wrapper #board-wrapper #game-board td {\n        width: 150px;\n        height: 150px;\n        transition: 0.2s; }\n        #page-wrapper #board-wrapper #game-board td:hover {\n          background-color: rgba(64, 62, 59, 0.1);\n          cursor: pointer; }\n      #page-wrapper #board-wrapper #game-board .left-column {\n        border-right: 2px solid #403e3b; }\n      #page-wrapper #board-wrapper #game-board .right-column {\n        border-left: 2px solid #403e3b; }\n      #page-wrapper #board-wrapper #game-board #top-row td {\n        border-bottom: 2px solid #403e3b; }\n      #page-wrapper #board-wrapper #game-board #bottom-row td {\n        border-top: 2px solid #403e3b; }\n\n#win-strike-container {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%; }\n\n.dialogShape {\n  width: 100px;\n  transition: 0.2s; }\n  .dialogShape:hover {\n    background-color: rgba(64, 62, 59, 0.1);\n    cursor: pointer; }\n\n.shapeDisplay {\n  width: 50px;\n  position: relative;\n  top: 15px;\n  right: 5px; }\n\n.playerDiv {\n  margin: 0 auto;\n  padding-bottom: 15px;\n  width: 220px; }\n\n#agentDiv {\n  width: 260px;\n  color: #403e3b; }\n\n.activePlayer {\n  border: 1px dashed #eb4e00;\n  border-radius: 15px; }\n\n#foot {\n  font-family: 'Ubuntu';\n  font-size: 18px;\n  background-color: #393937;\n  font-family: 'Open Sans';\n  color: aliceblue;\n  line-height: 28px;\n  width: 100%;\n  height: 80px;\n  text-align: center; }\n  #foot #foot-text {\n    position: relative;\n    top: 10px; }\n\n#foot i, #foot a {\n  color: #5bd28b;\n  transition: 0.6s;\n  text-decoration: none; }\n\n#foot a:hover, #gh-link:hover i {\n  color: aliceblue;\n  text-decoration: none; }\n\n#foot i {\n  padding-left: 2px; }\n", ""]);
